...
export const strings = {
  ...
  lihatSemuaSkill: (n: number) => `Lihat semua keahlian (${n})`,
  sembunyikanSkill: 'Sembunyikan keahlian',
  terkunci: 'Terkunci',
  penguasaan: 'Penguasaan',
  level: (n: number) => `Tingkat ${n}`,
  ...
  ujianLocked: (n: number) => `Kuasai semua keahlian Tingkat ${n} dulu (≥ 70%)`,
  ...
  locked: 'Terkunci',
  lockedHint: 'Kuasai keahlian sebelumnya dulu',
